...
public class PlayerControllerStg1 : MonoBehaviour
{
    enum State
    {
        Playing,
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire"))
        {
            ...
            GameObject bullet = GameManagerstg1.Instance.BulletPool.GetObject();
            if (bullet != null)
            {
    ...
    public void OnDead()
    {
        ...
        for (int i = 0; i < GameManagerstg1.Instance.BloodPool.GetComponent<ObjectPools>().InitialObjectNumber; i++)
        {
            GameObject blood = GameManagerstg1.Instance.BloodPool.GetObject();
            if (blood != null)
            {
